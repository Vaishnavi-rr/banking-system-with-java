...
//       
        ...
        try{
            ...
            ResultSet rs = c.s.executeQuery("select * from login where Account_No = '" + Accountno + "' and Login_Password = '" + pin + "'");
            while(rs.next()){
        ...
        try{
            ...
            ResultSet rs = c1.s.executeQuery("SELECT * FROM bank where Account_No = '" + Accountno + "' and Login_Password = '" + pin + "'");
            while(rs.next()){
